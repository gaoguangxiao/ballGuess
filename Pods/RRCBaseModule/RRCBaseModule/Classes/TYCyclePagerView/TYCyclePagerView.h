...
/**
 is Item Center default YES
 */
@property (nonatomic, assign) BOOL isItemCenter;

/**
 is Zoom
 */
@property (nonatomic, assign) BOOL isZoomType;
...
/**
 set zoom Animation Scale,but iszoomType must set true
 */
