...
//headView视图被添加时发送通知
extern NSString *const YNPageViewControllerHeadViewResetNotification;
...
/**
 UIScrollView拖动开始时回调, 可用来自定义 ScrollMenuView 传值
 
 @param pageViewController PageVC
 @param scrollView UIScrollView
 */
- (void)pageViewController:(YNPageViewController *)pageViewController
        didBeginDringting:(UIScrollView *)scrollView;
/**
...
/**
 刷新悬浮的HeaderViewFrame

 @param lastTopHeight 上次的高度
 */
