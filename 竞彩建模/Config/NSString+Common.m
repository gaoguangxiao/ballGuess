...
+ (NSString *)md5String:(NSString *)str{
    ...
    return [NSString stringWithFormat:
            @"%02x%02x%02x%02x%02x%02x%02x%02x",result[4], result[5], result[6], result[7],
...
-(NSMutableAttributedString *)containsString:(NSString *)str andkeyColor:(UIColor *)color{
    ...
    [strAtt addAttributes:@{NSForegroundColorAttributeName:color} range:NSMakeRange(range.location, range.length)];
    return strAtt;
}
-(NSMutableAttributedString *)backColroString:(NSString *)value1 andValue1:(NSString *)value2 andColor:(UIColor *)color{
    NSMutableAttributedString *tip = [[NSMutableAttributedString alloc] init];
    [tip appendAttributedString:[[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",value1] attributes:@{NSForegroundColorAttributeName:[UIColor lightGrayColor],NSFontAttributeName:[UIFont systemFontOfSize:13.0f]}]];
    [tip appendAttributedString:[[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",value2] attributes:@{NSForegroundColorAttributeName:color,NSFontAttributeName:[UIFont systemFontOfSize:15.0f]}]];
    return tip;
}
...
+(NSString *)textChangesencondPoint:(NSString *)text{
