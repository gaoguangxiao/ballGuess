...
-(void)setupResultModel:(ResultModel *)resultModel{
    ...
    //大小球盘口
    self.resultBigMoney.text = [NSString stringWithFormat:@"注量:%@",resultModel.finishBigMoney];
    ...
    //亚指结果
    self.resultYazhiMoney.text = [NSString stringWithFormat:@"注量:%@",resultModel.finishYazhiMoney];
    ...
    //波胆命中
    self.homeBdScore.text = [NSString stringWithFormat:@"%@ : %@",resultModel.bd_home_score,resultModel.bd_away_score];
//    self.awayBdScore.text = resultModel.bd_away_score;
