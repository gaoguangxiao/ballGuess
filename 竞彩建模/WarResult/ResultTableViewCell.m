...
@property (weak, nonatomic) IBOutlet UILabel *resultCompany;//大小球盘口
@property (weak, nonatomic) IBOutlet UILabel *resultForecastAllScore; //结果预测
@property (weak, nonatomic) IBOutlet UILabel *resultScoreDifference;//大小球数差值
...
-(void)setupResultModel:(ResultModel *)resultModel{
    ...
    self.resultScoreDifference.attributedText = [resultModel.finishScoreBigDif changeLineSpace:5];
    self.resultScoreDifference.textAlignment  = NSTextAlignmentCenter;
    self.resultScoreDifference.backgroundColor = resultModel.finishBigViewColor;
